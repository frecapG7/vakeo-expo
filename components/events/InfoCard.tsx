...
export const InfoCard = ({ icon, label, badge }: InfoCardProps) => {
  ...
  return (
    <View className="mb-4 bg-white dark:bg-gray-900 rounded-xl p-4 items-center">
      <IconSymbol name={icon} color="orange" size={24} />
      <View className="flex-row items-center gap-2 mt-2">
        <Text className="text-lg font-bold dark:text-white">{label}</Text>
        {badge && (
